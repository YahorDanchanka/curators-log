<template>
  <ThePage padding>
    ...
    <InteractionWithParentForm
      ...
      @submit="onSave(InteractionWithParentService.update(props.group.id, props.interactionWithParent.id, modelValue))"
    />
  </ThePage>
</template>
...
import { GroupModel, InteractionWithParentFormModel, InteractionWithParentTable } from '@/types'
...
const props = defineProps<{
  ...
  interactionWithParent: InteractionWithParentTable
}>()

const modelValue = ref<InteractionWithParentFormModel>(props.interactionWithParent)
</script>
