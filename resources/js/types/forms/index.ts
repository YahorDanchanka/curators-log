...
export * from './curator.form-model'
...
export * from './grade-report.form-model'
export * from './group-achievement.form-model'
export * from './group.form-model'
export * from './individual-work.form-model'
...
export * from './specialty.form-model'
export * from './student-achievement.form-model'
