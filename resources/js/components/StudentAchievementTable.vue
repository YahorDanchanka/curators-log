<template>
  <q-table :rows="props.achievements" :columns="columns" :rows-per-page-options="[0]" wrap-cells>
...
const props = defineProps<{ achievements: StudentAchievementTable[] }>()
const emit = defineEmits<{
  (e: 'create'): void
  (e: 'edit', achievement: StudentAchievementTable): void
  (e: 'delete', achievement: StudentAchievementTable): void
}>()
